...
####
# Modified torch hub conf so the no download happens as internet connection is
# disabled in Cassava Kaggle Competition
####
...
def resnext101_32x4d_ssl(progress=True, **kwargs):
    ...
    kwargs["width_per_group"] = 4
    return _resnext(
        semi_supervised_model_urls["resnext101_32x4d"],
        Bottleneck,
        [3, 4, 23, 3],
        True,
        progress,
...
def resnext101_32x8d_ssl(progress=True, **kwargs):
    ...
    return _resnext(
        semi_supervised_model_urls["resnext101_32x8d"],
        Bottleneck,
        [3, 4, 23, 3],
        True,
        progress,
...
def resnext101_32x16d_ssl(progress=True, **kwargs):
    ...
    return _resnext(
        semi_supervised_model_urls["resnext101_32x16d"],
        Bottleneck,
        [3, 4, 23, 3],
        True,
        progress,
...
def resnet18_swsl(progress=True, **kwargs):
    ...
    """
    return _resnet(
        semi_weakly_supervised_model_urls["resnet18"], 18, True, progress, **kwargs
    )
...
def resnet50_swsl(progress=True, **kwargs):
    ...
    """
    return _resnet(
        semi_weakly_supervised_model_urls["resnet50"], 50, True, progress, **kwargs
    )
...
def resnext101_32x4d_swsl(progress=True, **kwargs):
    ...
    kwargs["width_per_group"] = 4
    return _resnext(
        semi_weakly_supervised_model_urls["resnext101_32x4d"],
        Bottleneck,
        [3, 4, 23, 3],
        True,
        progress,
...
def resnext101_32x8d_swsl(progress=True, **kwargs):
    ...
    kwargs["width_per_group"] = 8
    return _resnext(
        semi_weakly_supervised_model_urls["resnext101_32x8d"],
        Bottleneck,
        [3, 4, 23, 3],
        True,
        progress,
...
def resnext101_32x16d_swsl(progress=True, **kwargs):
    ...
    kwargs["width_per_group"] = 16
    return _resnext(
        semi_weakly_supervised_model_urls["resnext101_32x16d"],
        Bottleneck,
        [3, 4, 23, 3],
        True,
        progress,
